...
const Header = () => {
  ...
  return (
    <div className="text-white w-full flex items-center justify-between md:justify-around">
      {pathname !== '/' && (
        <Link href="/">
        <div className="drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)] transition-transform hover:scale-110 mx-1 font-extrabold text-xl md:text-2xl relative inline-block stroke-current">
            Home
