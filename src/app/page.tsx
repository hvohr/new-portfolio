  ...
  return (
    <main className="bg-cover bg-no-repeat bg-center bg-[url('/12.jpeg')] font-wilden flex min-h-screen flex-col justify-between items-center p-10 pt-5">
      ...
      <div className="flex flex-col items-center mt-12 gap-4 flex-grow">
        ...
        <button className="text-3xl border-2 shadow-md shadow-slate-200 border-black rounded-xl p-1 transition-transform hover:scale-110 hover:bg-white"><a href="/Resume.pdf" download="Hollis Vohr Resume">View Resume</a></button>
      </div>
    </main>
  );
}
