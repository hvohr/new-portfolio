  ...
  return (
    <main className="bg-cover bg-no-repeat bg-center bg-[url('/12.jpeg')] font-wilden flex min-h-screen flex-col justify-between items-center md:p-10 p-3 pt-5">
      ...
      <div className="flex flex-col items-center mt-12 gap-4 flex-grow">
        ...
        <button className="text-black text-3xl border-2 shadow-sm shadow-slate-200 border-black rounded-xl p-1 transition-transform hover:scale-110 bg-white md:bg-transparent md:hover:bg-white"><a href="/Resume.pdf" download="Hollis Vohr Resume">View Resume</a></button>
      </div>
    </main>
  );
}
